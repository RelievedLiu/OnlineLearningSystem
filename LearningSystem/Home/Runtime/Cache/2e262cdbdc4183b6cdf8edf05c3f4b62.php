<?php if (!defined('THINK_PATH')) exit();?>﻿<!DOCTYPE html><html><head><title>关于我们</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><!-- 引入 Bootstrap --><link href="__PUBLIC__/css/bootstrap.min.css" rel="stylesheet"><!--[if lt IE 9]><script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script><script src="https://oss.maxcdn.com/libs/respond.js/1.3.0/respond.min.js"></script><![endif]--><!-- jQuery (Bootstrap 的 JavaScript 插件需要引入 jQuery) --><script src="__PUBLIC__/js/jquery-1.11.1.js"></script><!-- 包括所有已编译的插件 --><script src="__PUBLIC__/js/bootstrap.min.js"></script><script>			function  jump()
      ...
      text-align: center;
			 ...
			 </button></form></div></div></div><div class="row"><div class="col-lg-12"><div class="panel panel-default"><div class="panel-body"><img src="__PUBLIC__/images/school.jpg" class="img-circle" alt="Cinque Terre"><hr><br/><h4 class="text-success">地址：<a href="mailto:#">郑州市金水东路1号</a></h4><h4 class="text-success">电子邮件：<a href="mailto:#">mailto@somedomain.com</a></h4><h4 class="text-success">联系电话：<a href="mailto:#">86-371-65945879</a></h4><h4 class="text-success">邮编：<a href="mailto:#">450008</a></h4></div></div></div></div><footer class="my-footer"><p>河南中医药大学<br><small> Copyright by Institute of Information formation Technology.</small></p></footer></div></div></body></html>