<?php if (!defined('THINK_PATH')) exit();?>﻿<!DOCTYPE html><html><head><title>作业上传</title><meta http-equiv="content-type" content="text/html; charset=utf-8"></meta><meta name="viewport" content="width=device-width, initial-scale=1.0"><!-- 引入 Bootstrap --><link href="__PUBLIC__/css/bootstrap.min.css" rel="stylesheet"><!--[if lt IE 9]><script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script><script src="https://oss.maxcdn.com/libs/respond.js/1.3.0/respond.min.js"></script><![endif]--><!-- jQuery (Bootstrap 的 JavaScript 插件需要引入 jQuery) --><script src="__PUBLIC__/js/jquery-1.11.1.js"></script><!-- 包括所有已编译的插件 --><script src="__PUBLIC__/js/bootstrap.min.js"></script><script>			function  jump()
			{
	...
	.xc{
			 ...
			 </button></form></div></div></div><div class="row"><div class="col-lg-10 col-md-offset-1"><div class="panel panel-default"><div class="panel-body"><form action="/LearningSystem/index.php/User/do_upload"   method="post"   enctype="multipart/form-data"><label for="file"><p class="text-success">作业：</p></label><input type="file" name="photo1" id="file" ><br/><button type="submit" class="btn btn-primary" >提交</button></form></div></div></div></div><footer class="my-footer"><p>河南中医药大学<br><small> Copyright Institute of Information formation Technology.</small></p></footer></div></div></body></html>